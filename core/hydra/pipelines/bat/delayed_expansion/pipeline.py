# -*- coding: utf-8 -*-
import os
# Skytree Flasher / core/hydra/pipelines/bat/delayed_expansion/pipeline.py
"""
延迟变量展开
...
class DelayedExpansionBatPipeline:
    """延迟变量展开"""
    class_id = "delayed_expansion"
    class_name = "DelayedExpansionBatPipeline"
