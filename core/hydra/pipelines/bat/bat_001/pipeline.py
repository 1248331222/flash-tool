# -*- coding: utf-8 -*-
"""
bat_001 -- Pure fastboot command sequence (PLAIN_COMMANDS only).
...
import os
from .bat_001_sandbox.engine import BatSandboxEngine
...
COVERS = {"PLAIN_COMMANDS"}


class Pipeline:
    """bat_001: plain fastboot command sequence pipeline."""
    ...
    def parse(self, content, script_path="", rom_dir="", user_decisions=None, extra_args=""):
        ...
        return HydraParseResult(
            ...
            script_type="bat", class_id="bat_001"
        )