# -*- coding: utf-8 -*-
"""
bat_005 -- Fastboot flash script with exit and pause (PLAIN_COMMANDS only).
...
import os
from .bat_005_sandbox.engine import BatSandboxEngine
...
COVERS = {"EXIT", "PAUSE", "PLAIN_COMMANDS"}


class Pipeline:
    """bat_005: plain fastboot command sequence pipeline."""
    ...
    def parse(self, content, script_path="", rom_dir="", user_decisions=None, extra_args=""):
        ...
        return HydraParseResult(
            ...
            script_type="bat", class_id="bat_005"
        )