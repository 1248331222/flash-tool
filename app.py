...
_WEBDAV_BASE = "http://81.68.84.205:5244/dav"
_WEBDAV_AUTH = "Basic " + _b64.b64encode(b"123456:123456").decode()
del _b64
...
def run_server(host='127.0.0.1', port=8080, debug=False, ssl_context=None):
    """启动服务器"""
    # 启动前确保必要目录就绪
    init_directories()
    ...
    print("=" * 50)
    print(f"  本机访问: {protocol}://127.0.0.1:{port}")
    if host == '0.0.0.0':
