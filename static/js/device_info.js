...
function updateBtnState() {
    ...
    const hasDirectScript = (window._isNativeSh || window._isComplexScript) && window._shContent;
    document.getElementById('batchFlashBtn').disabled = !flashModeUsable || (stepList.length === 0 && !hasDirectScript);
