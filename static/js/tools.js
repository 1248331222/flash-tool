...
async function loadVbmetaRomList() {
    try {
        ...
        fillSelect(document.getElementById('vbmetaRomSelect'), dirNames, '选择刷机包');
    } catch(e) {}
}
